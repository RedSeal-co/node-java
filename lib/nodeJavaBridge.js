...
// Both before and after here are assumed to be functions that that one argument that is a node-callback function.
...
java.registerClientP = function(before, after) {
  if (java.isJvmCreated()) {
    throw new Error('java.registerClient() called after JVM already created.');
  }
  clients.push({beforeP: before, afterP: after});
}
